...
l <- ggplot(pca_points, aes(x = PC1, y = PC2)) +
  ...
  annotate('text', x = (pca_load$PC1*12.5), y = (pca_load$PC2*10),
...
# ggsave("Figures/Fig3-PCA.png", l, dpi = 600, width = 170, height = 170, units = "mm")
...
ggsave("Figures/Fig4-PCA-map.png", pcamap, width = 7, height = 7, dpi = 600)
