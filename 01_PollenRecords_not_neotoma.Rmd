...
plot(TORcal)
kable(TORage,format="markdown", caption= "Uncalibrated radiocarbon dates of Torran Beithe")
...
plot(CARcal)
kable(CARage, format = "markdown", caption = "Uncalibrated radiocarbon dates Carrach Mor")
...
plot(CAMcal)
#kable(CAMage, format = "markdown", caption = "Uncalibrated radiocarbon dates Camban")
...
plot(MORcal)
kable(MORage, format =  "markdown", caption = "Uncalibrated radiocarbon dates Morvich")

```

```{r create df same format as neotoma data sets }

dfTOR <- data.frame(site.name = "Torran Beithe",
                    depth = TOR$Sample,
...
dfCAR <- data.frame(site.name = "Carrach Mor",
                    depth = CAR$Sample,
...
dfCAM <- data.frame(site.name = "Camban",
                    depth = CAM$Sample,
                    ...
                    age.young = apply(CAMcal$thetaPredict, 2, "quantile", 
                                     probs = (1 - 0.95)/2),
                    date.type = "Bchron",                     lat = 57.213091, 
                    long = -5.2240879, 
                    dataset = 1, 
                    CAM[,-1])

dfMOR <- data.frame(site.name = "Morvich",
                    depth = MOR$Sample,
...
saveRDS(davies, "RDS_files/01_Pollen-Adavies.rds")
